...
export default function SignupPage() {
  ...
  const [isMedianApp, setIsMedianApp] = useState<boolean | null>(null);
  ...
  useEffect(() => {
    const initializeAuth = async () => {
      ...
      try {
        ...
        // Session check failed, continue with signup flow
        console.log("Session check failed:", error)
      }

      // Check for Median app
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isDuplicate) {
        const msg = isMedianApp
          ? "An account with this email already exists. Please sign in."
          : "An account with this email already exists. Please sign in or use Google.";
        setError(msg);
