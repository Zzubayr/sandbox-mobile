...
export default function AdminUsersPage() {
  ...
  const [target, setTarget] = useState<SimpleUser | null>(null);
  ...
  return (
    <div className="space-y-6">
              ...
              users.map((u) => (
                <tr key={u.id}>
                  ...
                  <td className="px-4 py-2 text-right">
                    <Button variant="destructive" size="sm" onClick={() => { setTarget(u); setConfirmOpen(true); }} disabled={busyId === u.id}>
      ...
      <ConfirmationDialog
        ...
        title="Delete user?"
        description={`This will permanently delete ${target?.email || "this user"} and all their data. This action cannot be undone.`}
        confirmText="Delete"
        cancelText="Cancel"
        variant="destructive"
